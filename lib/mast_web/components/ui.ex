defmodule MastWeb.Components.UI do
  ...
  # Returns a list of page numbers with `:gap` markers for ellipsis. Always
  # shows first, last, current, and current±1. Used by the table pagination
  # footer (see Pencil "Table/Pagination").
